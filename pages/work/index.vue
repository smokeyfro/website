<template>
  <nuxt-layout name="work">
    ...
    <div class="max-width:960@lg rel">
    ...
    <ul class="list-style:none m:0 p:0 grid-cols:1 grid-cols:2@lg gap:30">
      <li v-for="{ _path: slug, title, description, image, type } in work" :key="slug">
        <nuxt-link :to="slug" class="text-decoration:none color:#222 block bg:#fff b:1|solid|#ccc">
          <div class="w:full h:300@lg overflow:hidden">
          ...
          <div class="inline-block p:15 p:30@lg">
