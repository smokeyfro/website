...
export const UtilityLinks: Navigation[] = [
    {
        ...
        text: 'Changelog',
        title: '',
        icon: '<svg xmlns="http://www.w3.org/2000/svg" class="w:16 h:16 block" fill="none" stroke="#fff" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8h1a4 4 0 010 8h-1M2 8h16v9a4 4 0 01-4 4H6a4 4 0 01-4-4V8zM6 1v3M10 1v3M14 1v3"></path></svg>'
    }
]